...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] relative overflow-hidden p-8">
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="lg:col-span-2 flex flex-col items-center justify-center min-h-screen">
          {/* Logo/Title Section */}
          <div className="mb-16 animate-in fade-in slide-in-from-bottom-4 duration-700 text-center">
          ...
          {/* Footer Info */}
          <div className="mt-20 border-t border-slate-200 pt-8 max-w-md mx-auto text-center">
        ...
        {/* Right Column - Demo Credentials (1/3 width) */}
